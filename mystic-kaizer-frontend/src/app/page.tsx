  ...
  return (
    <div className="min-h-screen bg-[#111] text-white font-dark-mystic">
      ...
      <section className="min-h-screen bg-[url('/landing-page/mk-hero-bg.png')] bg-cover bg-center flex items-end pb-16 relative">
        ...
        <Image src="/landing-page/border.svg" alt="border" width={100} height={876} className="absolute top-5 left-12  lg:h-[600px] xl:h-[840px]" />
        <Image src="/landing-page/border.svg" alt="border" width={100} height={876} className="absolute top-5 right-12 lg:h-[600px] xl:h-[840px]" />
      </section>
